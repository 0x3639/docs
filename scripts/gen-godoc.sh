...
PACKAGES=(rpc/api rpc/api/embedded rpc/api/subscribe common common/types common/db common/crypto chain chain/nom chain/store chain/momentum chain/account chain/account/mailbox chain/genesis vm vm/vm_context vm/abi vm/constants vm/embedded/definition vm/embedded vm/embedded/implementation consensus consensus/api consensus/storage protocol protocol/downloader p2p p2p/discover p2p/nat rpc rpc/server wallet pow metadata zenon node verifier pillar app)
